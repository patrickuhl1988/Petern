...
const PET_TODAY_YES_DE = [
  ...
  "Peter empfiehlt: Gönn dir einen kleinen Kick: Lucky Strike, kalte Cola Zero. Schreib den anderen: Kind krank, leider geht es heute nicht.",
  "Peter empfiehlt: Schreibe den anderen „Leider muss ich heute länger arbeiten, sehr wichtiges Projekt\" und leg dich auf die Couch.",
  "Peter empfiehlt: Cola Zero holen, Füße hoch, Couch belegen und allen mitteilen: Heute leider keine Zeit.",
  "Peter empfiehlt: Schreib den anderen „Paket kommt heute. Muss zu Hause sein\".",
  "Peter empfiehlt: Schreib den Anderen „Download läuft noch – wichtiges Update, muss ich heute noch testen, deshalb kann ich nicht weg.\"",
  "Peter empfiehlt: Schreib den anderen „Muss ich mit Anika absprechen\" und melde dich nicht mehr.",
  "Peter empfiehlt: Schreib allen „Ich glaube, da ist eine Erkaeltung im Anflug. Ich bleibe besser daheim\" und nimm dir eine Cola Zero. Hilft. (Wirklich.)",
  "Peter empfiehlt: Schreib den anderen „Mal schauen, meld mich später\" und bleib auf der Couch. So geht Petern.",
  "Peter empfiehlt: Klingt gut, aber heute nicht. Schreib das, hol Cola Zero, Füße hoch.",
  "Peter empfiehlt: Schreib den anderen „Wichtige Mail muss noch raus, Konferenz vorbereiten\"",
  "Peter empfiehlt: Schreib den anderen „Anika braucht mich heute, Theo hat einen Termin – du musst da sein.\" Allen Bescheid geben und Couch sichern.",
...
const PET_TODAY_YES_EN = [
  ...
  "Peter recommends: Lucky Strike and a cold Coke Zero. Text the others: kid's sick, unfortunately doesn't work today.",
  "Peter recommends: Write the others „Unfortunately I have to work longer today, very important project\" and lay on the couch.",
  "Peter recommends: Get Coke Zero, feet up, claim the couch, and let everyone know: no time today, sorry.",
  "Peter recommends: Write to the others „Package arrives today. Need to be home.\" Perfect for petering in peace.",
  "Peter recommends: Write to the others „Download still running – important update, need to test it today, so can't leave.\"",
  "Peter recommends: Write to the others „I have to check with Anika\" and never reply to them.",
  "Peter recommends: Write to the others „Cold coming on. Better stay home.\" Coke Zero helps. (Really.)",
