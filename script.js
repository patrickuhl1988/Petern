...
const PET_TODAY_YES_DE = [
  ...
  "Peter empfiehlt: Router checken, Updates laufen lassen – und währenddessen auf der Couch entspannen. Sehr wichtig.",
  ...
  "Peter empfiehlt: Download läuft noch. Kann nicht weg. Klassiker – funktioniert immer.",
  ...
  "Peter empfiehlt: Spülmaschine ausräumen, Wäsche – so viel zu tun. Couch als Kommandozentrale.",
...
const PET_TODAY_YES_EN = [
  ...
  "Peter recommends: Check the router, let updates run – and relax on the couch meanwhile. Very important.",
  ...
  "Peter recommends: Download still running. Can't leave. Classic – always works.",
  ...
  "Peter recommends: Empty dishwasher, laundry – so much to do. Couch as command center.",
