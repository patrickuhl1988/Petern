...
const PET_TODAY_YES_DE = [
  ...
  "Couch ruft. Du kennst die Antwort.",
  "Cola Zero steht schon bereit. Petern.",
  "iPad ist geladen. Die Welt kann warten.",
  "Muss ich mit Anika absprechen … heißt: heute nein.",
  "Ist gerade schwierig. Immer.",
  "Social Battery leer. Klar petern.",
  "Router könnte Probleme machen. Sicherheits-Petern.",
  "Paket kommt vielleicht. Muss da sein. Petern.",
  "Download läuft noch. Kann nicht weg.",
  "Bin mental schon im Bett. Zählt.",
  "Habe da noch was offen. Immer.",
  "Meld mich später. Viel später.",
  "Irgendwann mal. Sicher nicht heute.",
  "Klingt gut, aber … mal schauen. Heute: nein.",
  "Je nachdem wie der Tag läuft. Er läuft zur Couch.",
  "Bin noch nicht so weit. Werde ich auch nicht.",
  "Will nichts versprechen. Außer: Couch.",
  "Das geht sich heute nicht aus. Geht nie.",
  "Mein Körper sagt Nein. Ich höre auf ihn.",
  "Brauch einen Tag Pause. Von allem.",
  "Zu viele Menschen diese Woche. Heute: null.",
  "Couch-Flow. Bin drin. Rausgehen geht nicht.",
  "Schon im Pyjama. Mental. Zählt doch.",
  "Energie-Level: unter null. Petern-Level: hoch.",
  "Terminkalender sagt: frei. Frei = Couch.",
  "Kollegen verstehen das. Oder nicht. Egal.",
  "Nächste Woche vielleicht. Bestimmt nicht.",
  "Klingt anstrengend. Ist es. Petern.",
  "Theo schläft? Perfekt. Petern-Zeit.",
  "Anika fragt zwar – aber die Couch sagt nein.",
];
const PET_TODAY_YES_EN = [
  ...
  "Couch calls. You know the answer.",
  "Coke Zero is ready. Peter.",
  "iPad is charged. The world can wait.",
  "Need to check with Anika … means: no today.",
  "It's tricky right now. Always.",
  "Social battery empty. Clearly Peter.",
  "Router might act up. Safety Peter.",
  "Package might arrive. Need to be here. Peter.",
  "Download still running. Can't leave.",
  "Mentally already in bed. Counts.",
  "Got something else pending. Always.",
  "I'll get back to you later. Much later.",
  "Someday. Definitely not today.",
  "Sounds good, but … we'll see. Today: no.",
  "Depends how the day goes. It goes to the couch.",
  "Not quite there yet. Won't be either.",
  "Don't want to promise. Except: couch.",
  "Doesn't work out today. Never does.",
  "My body says no. I'm listening.",
  "Need a day off. From everything.",
  "Too many people this week. Today: zero.",
  "Couch flow. I'm in it. Can't leave.",
  "Already in my PJs. Mentally. That counts.",
  "Energy level: below zero. Peter level: high.",
  "Calendar says: free. Free = couch.",
  "People will understand. Or not. Don't care.",
  "Maybe next week. Probably not.",
  "Sounds exhausting. It is. Peter.",
  "Theo's asleep? Perfect. Peter time.",
  "Anika might ask – but the couch says no.",
];
